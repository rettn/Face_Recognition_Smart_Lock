...
async def ws_recognize(websocket: WebSocket, session_token: str = Cookie(None)):
    ...
    await recognizer.recognize_with_websocket(websocket, esp_clients=esp_clients, max_frames=max_frames, similarity_threshold=similarity_threshold)
...
#python -m uvicorn src.server:app --host 0.0.0.0 --port 8000 --ws websocket